...
public class ExperimentTemperatureDependenceIntrinsic extends AppCompatActivity {
    int mTemperature = 0;
    int mMaxTemperature = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_experiment_temperature_dependence_intrinsic);
        ...
        ((TextView) findViewById(R.id.TemperatureDependenceIntrinsicTitle)).setTypeface(tajamuka);
        Log.i("TAG", "testing3");
        ...
        BackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExperimentTemperatureDependenceIntrinsic.this, ExperimentTemperatureDependenceFrontPage.class);
        ...
        HomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExperimentTemperatureDependenceIntrinsic.this, HomePage.class);
                startActivity(intent);
            }
        });
        Log.i("TAG", "testing5");

        findViewById(R.id.IntrinsicFullPlot).setVisibility(View.GONE);
        Log.i("TAG", "testing6");


        //Set up listener for temperature slider
        final SeekBar TemperatureSlider = findViewById(R.id.TemperatureSliderIntrinsic);
        TemperatureSlider.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean bool) {
                ...
                TextView temperatureOutput = findViewById(R.id.TemperatureIntrinsicOutput);
                ...
                ImageView graphPlotFull = findViewById(R.id.IntrinsicFullPlot);
                ImageView bandDiagram = findViewById(R.id.IntrinsicBandDiagram);
                Log.i("TAG", "testing10");
                ...
                if (temperature >= 0) {
                    ...
                    graphPlotFull.setImageResource(getResources().getIdentifier("experiment_temperature_dependence_intrinsic_plot_" + (temperature), "drawable", "cambridge.materials.galliumnitride.app.ledlab"));
                    bandDiagram.setImageResource(getResources().getIdentifier("experiment_temperature_dependence_intrinsic_" + (temperature), "drawable", "cambridge.materials.galliumnitride.app.ledlab"));
                    Log.i("TAG", "testing14");
                }
