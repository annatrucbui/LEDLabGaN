...
public class ExperimentTemperatureDependenceNType extends AppCompatActivity {
    int mTemperature = 0;
    int mMaxTemperature = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_experiment_temperature_dependence_ntype);
        ...
        ((TextView) findViewById(R.id.TemperatureDependencenTypeTitle)).setTypeface(tajamuka);
        Log.i("TAG", "testing3");
        ...
        BackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExperimentTemperatureDependenceNType.this, ExperimentTemperatureDependenceFrontPage.class);
        ...
        HomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExperimentTemperatureDependenceNType.this, HomePage.class);
                startActivity(intent);
            }
        });
        Log.i("TAG", "testing5");

        findViewById(R.id.nTypeFullPlot).setVisibility(View.GONE);
        Log.i("TAG", "testing6");


        //Set up listener for temperature slider
        final SeekBar TemperatureSlider = findViewById(R.id.TemperatureSlidernType);
        TemperatureSlider.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean bool) {
                ...
                TextView temperatureOutput = findViewById(R.id.TemperaturenTypeOutput);
                ...
                ImageView graphPlotFull = findViewById(R.id.nTypeFullPlot);
                ImageView bandDiagram = findViewById(R.id.nTypeBandDiagram);
                Log.i("TAG", "testing10");
                ...
                if (temperature >= 0) {
                    ...
                    bandDiagram.setImageResource(getResources().getIdentifier("experiment_temperature_dependence_ntype_" + (temperature), "drawable", "cambridge.materials.galliumnitride.app.ledlab"));
                    Log.i("TAG", "testing14");
                }
